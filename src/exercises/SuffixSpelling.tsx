...
const ITEMS: TextItem[] = [
  ...
  // ─── Прилагательные на -овый/-евый ───────────────────────────────────────
  { display: 'бяз_вый',                 answer: 'бязевый' },
  { display: 'парч_вый',                answer: 'парчовый' },
  { display: 'ситц_вый',                answer: 'ситцевый' },
  { display: 'кумач_вый',               answer: 'кумачовый' },
  { display: 'холщ_вый',                answer: 'холщовый' },
  { display: 'фланел_вый',              answer: 'фланелевый' },
  { display: 'каракул_вый',             answer: 'каракулевый' },
  { display: 'тюл_вый',                 answer: 'тюлевый' },
  { display: 'чесуч_вый',               answer: 'чесучовый' },
  // ─── Глаголы на -евать (Е, не -ивать) ────────────────────────────────────
  { display: 'намер_ваться',            answer: 'намереваться' },
  { display: 'увещ_вать',               answer: 'увещевать' },
  { display: 'застр_вать',              answer: 'застревать' },
  { display: 'продл_вать',              answer: 'продлевать' },
  { display: 'обур_вать',               answer: 'обуревать' },
  { display: 'обозр_вать',              answer: 'обозревать' },
  { display: 'сомн_ваться',             answer: 'сомневаться' },
  { display: 'подозр_вать',             answer: 'подозревать' },
  { display: 'подразум_вать',           answer: 'подразумевать' },
  { display: 'раз_вать',                answer: 'разевать' },
  { display: 'встр_вать',               answer: 'встревать' },
  // ─── -овать/-евать vs -ивать (по 1 л. ед. ч.) ────────────────────────────
  { display: 'потч_вать',               answer: 'потчевать' },
  { display: 'поч_вать',                answer: 'почивать' },
  // ─── Прилагательные с суффиксом -ск- от основ на -к ──────────────────────
  { display: 'узбек__ий',               answer: 'узбекский' },
  { display: 'таджик__ий',              answer: 'таджикский' },
];
