...
const ITEMS: Item[] = [
  ...
  { display: 'манеры изыска_ы', single: 'манеры изысканы', double: 'манеры изысканны', answer: 'double', hint: 'краткое прилагательное' },

  // Дополнительный набор
  { display: 'златотка_ые одежды', single: 'златотканые одежды', double: 'златотканные одежды', answer: 'single' },
  { display: 'лицо румя_о', single: 'лицо румяно', double: 'лицо румянно', answer: 'single' },
  { display: 'свежевыкраше_ые стены', single: 'свежевыкрашеные стены', double: 'свежевыкрашенные стены', answer: 'double' },
  { display: 'лома_ая линия', single: 'ломаная линия', double: 'ломанная линия', answer: 'single' },
  { display: 'пута_ые фразы', single: 'путаные фразы', double: 'путанные фразы', answer: 'single' },
  { display: 'гружё_ый состав', single: 'гружёный состав', double: 'гружённый состав', answer: 'single', hint: 'без зависимых слов' },
  { display: 'сгущё_ое молоко', single: 'сгущёное молоко', double: 'сгущённое молоко', answer: 'double' },
  { display: 'ржа_ое поле', single: 'ржаное поле', double: 'ржанное поле', answer: 'single' },
  { display: 'золочё_ая поверхность', single: 'золочёная поверхность', double: 'золочённая поверхность', answer: 'single' },
  { display: 'точё_ый силуэт', single: 'точёный силуэт', double: 'точённый силуэт', answer: 'single' },
  { display: 'белё_ая стена', single: 'белёная стена', double: 'белённая стена', answer: 'single' },
  { display: 'тка_ая скатерть', single: 'тканая скатерть', double: 'тканная скатерть', answer: 'single' },
  { display: 'некраше_ая лавка', single: 'некрашеная лавка', double: 'некрашенная лавка', answer: 'single' },
  { display: 'развеша_ые снасти', single: 'развешаные снасти', double: 'развешанные снасти', answer: 'double' },
  { display: 'рва_ые башмаки', single: 'рваные башмаки', double: 'рванные башмаки', answer: 'single' },
  { display: 'багря_ые полосы', single: 'багряные полосы', double: 'багрянные полосы', answer: 'single' },
  { display: 'нарисова_ы тушью', single: 'нарисованы тушью', double: 'нарисованны тушью', answer: 'single', hint: 'краткое причастие' },
  { display: 'изыска_о вежлив', single: 'изыскано вежлив', double: 'изысканно вежлив', answer: 'double', hint: 'наречие' },
  { display: 'необыкнове_о естественны', single: 'необыкновено естественны', double: 'необыкновенно естественны', answer: 'double' },
  { display: 'необыкновенно естестве_ы', single: 'необыкновенно естествены', double: 'необыкновенно естественны', answer: 'double', hint: 'краткое прилагательное' },
  { display: 'посеребрё_ое пенсне', single: 'посеребрёное пенсне', double: 'посеребрённое пенсне', answer: 'double' },
  { display: 'полотня_ые скатерти', single: 'полотняные скатерти', double: 'полотнянные скатерти', answer: 'single' },
  { display: 'удостое_ы наград', single: 'удостоены наград', double: 'удостоенны наград', answer: 'single', hint: 'краткое причастие' },
  { display: 'рожде_ы для счастья', single: 'рождены для счастья', double: 'рожденны для счастья', answer: 'single', hint: 'краткое причастие' },
  { display: 'была приуроче_а', single: 'была приурочена', double: 'была приуроченна', answer: 'single', hint: 'краткое причастие' },
  { display: 'малоезже_ое поле', single: 'малоезженое поле', double: 'малоезженное поле', answer: 'single' },
];
