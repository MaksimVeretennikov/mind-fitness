...
const ITEMS: TextItem[] = [
  ...
  // ─── Добавлено: причастия и спорные пары ─────────────────────────────────
  { display: 'движ_мый',                         answer: 'движимый' },
  { display: 'недвиж_мый',                       answer: 'недвижимый' },
  { display: 'развеш_нные картины',              answer: 'развешанные' },
  { display: 'развеш_нная мука',                 answer: 'развешенная' },
  { display: 'выкач_нная нефть',                 answer: 'выкачанная' },
  { display: 'пристрел_нное ружьё',              answer: 'пристрелянное' },
  { display: 'пристрел_нный заяц',               answer: 'пристреленный' },
  { display: 'выровн_нный пол',                  answer: 'выровненный' },
  { display: 'выравн_нные строки',               answer: 'выравненные' },
  { display: 'подровн_нная чёлка',               answer: 'подровненная' },
  { display: 'подравн_нные результаты',          answer: 'подравненные' },
  { display: 'рассвет брезж_т',                  answer: 'брезжит' },
  { display: 'звёзды брезж_т',                   answer: 'брезжат' },
  { display: 'брезж_щий рассвет',                answer: 'брезжущий' },
  { display: 'вывал_нный в снегу',               answer: 'вывалянный' },
  { display: 'вывал_нный на свалку',             answer: 'вываленный' },
  { display: 'замеш_нный в преступлении',        answer: 'замешанный' },
  { display: 'замеш_нное тесто',                 answer: 'замешенное' },
  // ─── Инфинитивы I спряжения на -еть (Е) ──────────────────────────────────
  { display: 'бел_ть от старости',               answer: 'белеть' },
  { display: 'вид_ть',                           answer: 'видеть' },
  { display: 'выздоров_ть',                      answer: 'выздороветь' },
  { display: 'заберемен_ть',                     answer: 'забеременеть' },
  { display: 'завис_ть от погоды',               answer: 'зависеть' },
  { display: 'запечатл_ть',                      answer: 'запечатлеть' },
  { display: 'заплеснев_ть',                     answer: 'заплесневеть' },
  { display: 'ненавид_ть',                       answer: 'ненавидеть' },
  { display: 'обезум_ть',                        answer: 'обезуметь' },
  { display: 'обид_ть',                          answer: 'обидеть' },
  { display: 'опостыл_ть',                       answer: 'опостылеть' },
  { display: 'опротив_ть',                       answer: 'опротиветь' },
  // ─── Инфинитивы I спряжения на -ать (А) ──────────────────────────────────
  { display: 'вороч_ться',                       answer: 'ворочаться' },
  { display: 'дрем_ть',                          answer: 'дремать' },
  { display: 'жажд_ть',                          answer: 'жаждать' },
  { display: 'рокот_ть',                         answer: 'рокотать' },
  { display: 'клокот_ть',                        answer: 'клокотать' },
  { display: 'колеб_ться',                       answer: 'колебаться' },
  { display: 'курлык_ть',                        answer: 'курлыкать' },
  { display: 'присып_ть',                        answer: 'присыпать' },
  { display: 'слыш_ть',                          answer: 'слышать' },
  // ─── Инфинитивы I спряжения на -ять (Я) ──────────────────────────────────
  { display: 'ба_ть небылицы',                   answer: 'баять' },
  { display: 'бле_ть',                           answer: 'блеять' },
  { display: 'ве_ть прохладой',                  answer: 'веять' },
  { display: 'гра_ть',                           answer: 'граять' },
  { display: 'зате_ть',                          answer: 'затеять' },
  { display: 'кашл_ть',                          answer: 'кашлять' },
  { display: 'ка_ться',                          answer: 'каяться' },
  { display: 'клан_ться',                        answer: 'кланяться' },
  { display: 'ла_ть',                            answer: 'лаять' },
  { display: 'леле_ть',                          answer: 'лелеять' },
  { display: 'ма_ться',                          answer: 'маяться' },
  { display: 'наде_ться',                        answer: 'надеяться' },
  { display: 'отча_ться',                        answer: 'отчаяться' },
  { display: 'ре_ть',                            answer: 'реять' },
  { display: 'се_ть',                            answer: 'сеять' },
  { display: 'соде_ть',                          answer: 'содеять' },
  { display: 'та_ть',                            answer: 'таять' },
  { display: 'ха_ть',                            answer: 'хаять' },
  { display: 'ча_ть',                            answer: 'чаять' },
  { display: 'чу_ть',                            answer: 'чуять' },
  // ─── Инфинитивы II спряжения на -ить (И) ─────────────────────────────────
  { display: 'бел_ть потолок',                   answer: 'белить' },
  ...
  { display: 'муч_ть',                           answer: 'мучить' },
  { display: 'скро_ть',                          answer: 'скроить' },
  { display: 'стро_ть',                          answer: 'строить' },
];
