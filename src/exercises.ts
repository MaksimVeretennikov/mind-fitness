...
export const RUSSIAN_EXERCISES: Exercise[] = [
  ...
  },
  {
    id: 'abbreviations',
    title: 'Аббревиатуры',
    description: 'Проверьте, знаете ли вы расшифровку популярных российских аббревиатур.',
    icon: '🔤',
    color: 'text-indigo-700',
    gradient: 'from-indigo-500 to-blue-600',
  },
...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    id: 'schulte',
    title: 'Зоркий глаз',
    description: 'Кликайте числа по возрастанию из случайного набора. Тренирует скорость восприятия и переключение внимания.',
    icon: '👁️',
